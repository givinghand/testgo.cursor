        ...
        <div className="hidden md:flex items-center space-x-3">
                ...
                <NavigationMenuItem key={link.to}>
                  <Link to={link.to} legacyBehavior passHref>
                    <NavigationMenuLink
                      className={cn(
                        navigationMenuTriggerStyle(),
                        "text-base font-semibold text-foreground hover:text-primary hover:bg-primary/5"
                      )}
                    >
                      {link.text}
                    </NavigationMenuLink>
          ...
          <Link to="/giris" legacyBehavior passHref>
            <Button
              variant="ghost"
              size="sm"
              className="text-base font-semibold text-foreground hover:text-primary hover:bg-primary/5"
            >
              Giriş Yap
            </Button>
          </Link>
          <Button asChild size="sm" className="text-base font-semibold">
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col p-4 space-y-2">
              ...
              >
                <Link to="/uye-ol" onClick={() => setIsOpen(false)}>
                  Sen de Katıl
                </Link>
              </Button>
            </div>
